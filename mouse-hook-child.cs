    ...
    private static IntPtr Callback(int nCode, IntPtr wParam, IntPtr lParam)
    {
        if (nCode >= 0)
        {
            ...
            switch (msg)
            {
                ...
                case 0x020B:
                    int xb1 = (Marshal.ReadInt32(lParam, 8) >> 16) & 0xFFFF;
                    if (xb1 == 1) Output("mousedown", 4);
                    else if (xb1 == 2) Output("mousedown", 5);
                    break;
                case 0x020C:
                    int xb2 = (Marshal.ReadInt32(lParam, 8) >> 16) & 0xFFFF;
                    if (xb2 == 1) Output("mouseup", 4);
                    else if (xb2 == 2) Output("mouseup", 5);
                    break;
            }
        }
